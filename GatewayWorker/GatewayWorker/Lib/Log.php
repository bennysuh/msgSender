...
{           
        ...
        protected function __construct(){//注意：以下是配置文件中的常量，请读者自行更改
            ...
            $this->log_max_len    = 10 * 1024 * 1024 ; //10M 
        }  
         ...
         *  
         */  
        public function log($type=1,$desc){  
            if($this->log_switch){
                ...
                // if(is_array($desc)){
                    $filename = $this->log_file_pre . $this->get_max_log_file_suf();
                    file_put_contents($this->log_file_path . $filename, "<?php \nreturn " . stripslashes(var_export($desc, true)) . ";".chr(13), FILE_APPEND);
                // }
            }  
        }  
