...
class Db
{
    ...
    {
        if(!isset(\GatewayWorker\Config\Db::$$config_name))
        {
            echo "\\GatewayWorker\\Config\\Db::$config_name not set\n";
            throw new \Exception("\\GatewayWorker\\Config\\Db::$config_name not set\n");
        }
        
        if(empty(self::$instance[$config_name]))
        {
            $config = \GatewayWorker\Config\Db::$$config_name;
